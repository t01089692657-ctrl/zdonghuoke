...
| [docs/06-上线接入指南.md](docs/06-上线接入指南.md) | **从演示到真实可用**：旗舰/够用/全免费三档配置、要接入哪些服务、注册入口、拿哪些 Key、Mac mini 当云服务器、上线节奏 | 所有想真跑起来的人 |
| [docs/07-价格总览.md](docs/07-价格总览.md) | **各服务价格明细（2026-07）+ 三档配置月成本估算**：逐项报价、免费额度、$0/$80/$150 三档总花费 | 做预算的人 |
| [docs/08-对抗性代码审查报告.md](docs/08-对抗性代码审查报告.md) | **多智能体对抗性审查结果**：78 智能体 7 维度审查 + 每条发现 2 反驳者验证；已修复的 critical/high/medium 问题与遗留项 | 工程师 |
